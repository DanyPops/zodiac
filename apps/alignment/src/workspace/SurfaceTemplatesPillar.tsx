...
export function SurfaceTemplatesPillar({ entries, onDockDefault, canSaveCurrent, onSaveCurrentAsTemplate }: SurfaceTemplatesPillarProps): React.JSX.Element {
	...
	return (
		<nav aria-label="Surface Templates" className="relative z-20 flex h-full w-14 shrink-0 flex-col border-l border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
