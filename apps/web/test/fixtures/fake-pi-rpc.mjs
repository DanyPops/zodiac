...
// JSONL framing as the real protocol (docs/rpc.md). Used by
// process-rpc-session.test.ts to exercise real child-process spawning and
// stdout framing against a real process, not a mocked child_process module.
